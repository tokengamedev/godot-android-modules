...
val pluginName = "GooglePlayGameServices"
val pluginPackage = "gaml.google.play.game.services"
...
extra.apply {
    ...
    set("pluginDescription", "Android plugin for Google play game services")
}
